...
uses cefconsole, kefreeutil, consolefrm;
{ THelloWorldPlugin }
...
begin
  ...
  consoleforms.currentfile := getCurrentFile;
  consoleforms.currentpathfile := getCurrentPathFile;
...
var
  ...
  p : ^TToolbarData;
begin
  p^.ClientHandle := consoleforms.Handle;
  ...
  SendMessage(getCurScintilla(), NPPM_DMMSHOW, 0, LPARAM(consoleforms.handle));
