{
    Support unit for scintilla use in pascal. The constants are all created from
    scintilla.iface by a python script.
...
// =============================================================================
// Scintilla v5.3.1 as of Notepad++ v8.4.7
// =============================================================================
...
type
  ...
  PCharacterRangeFull = ^TCharacterRangeFull;

  TCharacterRangeFull = record
    cpMin : sciPosition;
    cpMax : sciPosition;
  end;
  ...
  PTextToFindFull = ^TTextToFindFull;
  ...
  PRangeToFormatFull = ^TRangeToFormatFull;

  TRangeToFormatFull = record
    hdc       : TSurfaceID;
    hdcTarget : TSurfaceID;
    rc        : TRectangle;
    rcPage    : TRectangle;
