...
//  IDM_FORMAT_CONVERT                               = 200;
  ...
  IDM_LANG_USER_LIMIT                              = (IDM_LANG + 210);     //46210: Max. 30 user defined languages, adjust with IDM_LANG_USER
...
// IDM_SETTING_EDGE_SIZE                             = (IDM_SETTING + 4);
  ...
  // Menu Run
  // ---------------------------------------------------------------------------
  // The entries of the menu Run are created dynamically during run time
  ...
  // execpt the entries "Plugins Admin" and "Open Plugins Folder". But their
  // IDs derive from "Settings" menu.
